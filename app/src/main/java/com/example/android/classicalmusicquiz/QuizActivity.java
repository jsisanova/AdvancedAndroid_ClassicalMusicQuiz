...
// https://github.com/udacity/AdvancedAndroid_ClassicalMusicQuiz/compare/TMED.03-Exercise-EventListening...TMED.03-Solution-EventListening?expand=1
// TODO (1): Have this Activity implement ExoPlayer.EventListener and add the required methods. to monitor state changes in exoplayer
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    // playWhenReady = true:playing, false:paused;
    // playbackState = STATE_IDLE, STATE_BUFFERING, STATE_READY, STATE_ENDED
    @Override
