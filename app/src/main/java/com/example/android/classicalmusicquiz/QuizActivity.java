...
// https://github.com/udacity/AdvancedAndroid_ClassicalMusicQuiz/compare/TMED.05-Exercise-AddMediaNotification...TMED.05-Solution-AddMediaNotification?expand=1
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    /**
     * Shows Media Style notification, with an action that depends on the current MediaSession; to verify thay MediaSession works as intended
     * PlaybackState.
    ...
    private void showNotification(PlaybackStateCompat state) {
        ...
        int icon;
        String play_pause;
        // if state is STATE_PLAYING, use play action, else pause action
        ...
        // create 2 notification actions, one for play / pause, one for restart
        ...
        // use NotoficationManager to deliver the notification
