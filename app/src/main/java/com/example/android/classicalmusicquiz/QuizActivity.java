...
// https://github.com/udacity/AdvancedAndroid_ClassicalMusicQuiz/compare/TMED.04-Exercise-AddMediaSession...TMED.04-Solution-AddMediaSession?expand=1
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    private void initializeMediaSession() {
        ...
        // null -> Do not let MediaButtons restart the player (=start the app) when the app is not visible (=stopped).
        ...
        mStateBuilder = new PlaybackStateCompat.Builder()
                .setActions(
                        PlaybackStateCompat.ACTION_PLAY |
                                ...
                                PlaybackStateCompat.ACTION_PLAY_PAUSE);   // play-pause toggle
    ...
    /**
     * Method that is called every time the ExoPlayer state changes (eg button is clicked via INTERNAL OR EXTERNAL CLIENT) ). Used to update the MediaSession
     * PlayBackState to keep in sync.
     * @param playWhenReady true if ExoPlayer is playing, false if it's paused.
     * @param playbackState int describing the state of ExoPlayer. Can be STATE_READY, STATE_IDLE,
     *                      STATE_BUFFERING, or STATE_ENDED.
     */
    // to make ExoPlayer view buttons communicate with MediaSession or it's callbacks, we need media controller class for it.
    // = by PlaybackStateCompat Builder class to build PlaybackStateCompat object
    @Override
    ...
    // TODO (2): Create an inner class that extends MediaSessionCompat.Callbacks,
    // TODO - and override the onPlay(), onPause(), and onSkipToPrevious() callbacks. Pass an instance of this class into the MediaSession.setCallback() method in the method you created in TODO 1.
    /**
